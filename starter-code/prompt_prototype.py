...
# Google now expects the full model name with the models/ prefix for newer accounts.
...
def evaluate_prompt(user_input: str) -> str:
    ...
    try:
        ...
        # The legacy SDK expects name without the models/ prefix in some versions.
        legacy_model_name = GEMINI_MODEL.replace("models/", "")
