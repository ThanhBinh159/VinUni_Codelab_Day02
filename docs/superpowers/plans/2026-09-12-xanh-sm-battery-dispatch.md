...
Expected after review hardening: `18 passed` and exit code 0, including Windows console encoding, missing/conflicting context, strict JSON verification, and code-owned online policy tests.
